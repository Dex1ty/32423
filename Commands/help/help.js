    ...
    const help = new Discord.MessageEmbed();
        ...
        helpall.setTitle("Bot Commands")
            ...
            .addFields({
                    ...
                    value: (
                        "\`8ball\` \`animeface\` \`animequote\` \`baka\` \`fight\` \`hug\` \`joke\` \`joust\` \`lolice\` \`nom\` \`pokedex\` \`punch\` \`rate\` \`rps\` \`wink\`"
                    ),
                    inline: false                       
            })
            .addFields({
            ...
            .addFields({
                ...
                value: (
                    "\`bal\` \`beg\` \`buy\` \`chopwood\` \`craft\` \`daily\` \`fish\` \`fishtypes\` \`hourly\` \`mine\` \`prcreate\` \`rob\` \`sell\` \`shop\` \`work\`"
                ),
                inline: false
            });
            ...
            .addFields({
                ...
                value: (
                    ...
                    `!lolice - Call the Loli Police on someone. \n` +
                    `!nom - Nom on another user. Yum~ \n` +
                    `!pokedex - Find the states of a Pokemon. \n` +
                ...
                .addFields({
                    name: "Commands",
                    value: (
                        `!leaderboard - Shows the top 10 people with the most xp within that specified server. \n` +
                ...
                value: (
                    ...
                    `!beg - Beg for me, I-I mean beg on the streets for some money. \n` + 
                    `!buy - Buy some items from me. \n` +
                    `!chopwood - Get your lumberjacks to work for you \n` +
                    `!daily - Get your daily allowance. \n` +
                    `!fish - Fish for some fish and get some money for it. \n` +
                    `!fishtypes - Find the types of fish that can be caught. \n` +
                    ...
                    `!sell - Sell some of the items from your inventory. \n` +
                    `!shop - Check out some of the items that I am selling. \n` +
                    `!weekly - Get your weekly allowance. \n` +
