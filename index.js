...
client.on('ready', () => {
  ...
  setInterval(() => {
    ...
    client.user.setPresence({ activity: { name: `${PREFIX}help | ${statusQ}`, type: "PLAYING" }, status: "dnd" }); 
    index++;
  }, 20000)
...
//Level up message
message.channel.send(`${message.member}, you have proceeded to level ${user.level}. Continue earning xp.`)
} 
